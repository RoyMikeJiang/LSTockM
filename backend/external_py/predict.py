...
if __name__ == '__main__':
    ...
    stock_list = ''
    try:
        cursor.execute("SELECT stock_id, stock_symbol, model_path FROM stock_info si LEFT OUTER JOIN lstm_path USING (stock_id) WHERE stock_id={}".format(args.stock_id))
